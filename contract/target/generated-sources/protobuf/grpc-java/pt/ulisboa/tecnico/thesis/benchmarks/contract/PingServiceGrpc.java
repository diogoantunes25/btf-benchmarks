...
public final class PingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "pt.ulisboa.tecnico.thesis.benchmarks.contract.PingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping,
      pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong> getPingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ping",
      requestType = pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping.class,
      responseType = pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping,
      pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong> getPingMethod() {
    io.grpc.MethodDescriptor<pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping, pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong> getPingMethod;
      ...
      synchronized (PingServiceGrpc.class) {
        if ((getPingMethod = PingServiceGrpc.getPingMethod) == null) {
          PingServiceGrpc.getPingMethod = getPingMethod =
              io.grpc.MethodDescriptor.<pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping, pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ping"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong.getDefaultInstance()))
  ...
  public static abstract class PingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void ping(pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping request,
        io.grpc.stub.StreamObserver<pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping,
                pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong>(
                  this, METHODID_PING)))
          .build();
    }
  }
  ...
  public static final class PingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PingServiceBlockingStub> {
    ...
    /**
     */
    public pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong ping(pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping request) {
  ...
  public static final class PingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong> ping(
        pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PING:
          serviceImpl.ping((pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Ping) request,
              (io.grpc.stub.StreamObserver<pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.Pong>) responseObserver);
          break;
        default:
  ...
  private static abstract class PingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return pt.ulisboa.tecnico.thesis.benchmarks.contract.PingServiceOuterClass.getDescriptor();
    }
